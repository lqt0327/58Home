...
export default function Index(props) {
    ...
    const [ isPullDown, setPullDown] = useState(false)
    useEffect(() => {
        let scroll = new BScroll(homeRef.current, {
            pullDownRefresh: {
                threshold: 50,
                stop: 20,
            },
    ...
    return (
        <>
        <div className={isPullDown ? "hide" : Css['search-header']} ref={HScroll}>
        ...
        <div className={Css['home']} ref={homeRef}
        >
            <div className={Css['page']} >
            <div style={{textAlign:'center',display: isPullDown ? 'block': 'none'}}>
                加载中……
            </div>
